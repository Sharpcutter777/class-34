...
var food;
var rabbit;
var gray_star,one_star,two_star
var edges;
...
function preload()
{
  ...
  gray_star = loadAnimation("empty.png")
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope2 = new Rope(8,{x:485,y:90});

  blower = createImg('baloon2.png')
  blower.position(270,390)
  blower.size(100,100)
  blower.mouseClicked(blow)
  star1=createSprite(300,75)
  star1.addImage(starImg)
  star1.scale = 0.025

  star2 = createSprite(100,390)
...
function collide(body,sprite,pos)
{
  if(body!=null)
        {
